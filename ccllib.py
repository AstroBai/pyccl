...
class physical_constants(object):
    ...
    __repr__ = _swig_repr
    YEAR = property(_ccllib.physical_constants_YEAR_get, _ccllib.physical_constants_YEAR_set, doc=r"""YEAR : double""")
...
class parameters(object):
    ...
    T_ncdm = property(_ccllib.parameters_T_ncdm_get, _ccllib.parameters_T_ncdm_set, doc=r"""T_ncdm : double""")
...
def parameters_create(Omega_c, Omega_b, Omega_k, Neff, mnu, n_mnu, w0, wa, h, A_s, sigma8, n_s, T_CMB, Omega_g, T_ncdm, bcm_log10Mc, bcm_etab, bcm_ks, mu_0, sigma_0, c1_mg, c2_mg, lambda_mg, nz_mgrowth, zarr_mgrowth, dfarr_mgrowth, status):
    r"""parameters_create(double Omega_c, double Omega_b, double Omega_k, double Neff, double * mnu, int n_mnu, double w0, double wa, double h, double A_s, double sigma8, double n_s, double T_CMB, double Omega_g, double T_ncdm, double bcm_log10Mc, double bcm_etab, double bcm_ks, double mu_0, double sigma_0, double c1_mg, double c2_mg, double lambda_mg, int nz_mgrowth, double * zarr_mgrowth, double * dfarr_mgrowth, int * status) -> parameters"""
    return _ccllib.parameters_create(Omega_c, Omega_b, Omega_k, Neff, mnu, n_mnu, w0, wa, h, A_s, sigma8, n_s, T_CMB, Omega_g, T_ncdm, bcm_log10Mc, bcm_etab, bcm_ks, mu_0, sigma_0, c1_mg, c2_mg, lambda_mg, nz_mgrowth, zarr_mgrowth, dfarr_mgrowth, status)
...
def parameters_m_nu_set_custom(params, mass):
    r"""parameters_m_nu_set_custom(parameters params, double * mass)"""
    return _ccllib.parameters_m_nu_set_custom(params, mass)

def parameters_mgrowth_set_custom(params, zarr, dfarr):
    r"""parameters_mgrowth_set_custom(parameters params, double * zarr, double * dfarr)"""
    return _ccllib.parameters_mgrowth_set_custom(params, zarr, dfarr)
...
def angular_cl_vec_limber(cosmo, clt1, clt2, pspec, ell, integration_type, nout, status):
    r"""angular_cl_vec_limber(cosmology cosmo, cl_tracer_collection_t clt1, cl_tracer_collection_t clt2, f2d_t pspec, double * ell, int integration_type, int nout, int * status)"""
...
def Omeganuh2(a, N_nu_mass, mnu, T_CMB, T_ncdm, status):
    r"""Omeganuh2(double a, int N_nu_mass, double * mnu, double T_CMB, double T_ncdm, int * status) -> double"""


    return _ccllib.Omeganuh2(a, N_nu_mass, mnu, T_CMB, T_ncdm, status)

def Omeganuh2_vec(N_nu_mass, T_CMB, T_ncdm, a, mnu, nout, status):
    r"""Omeganuh2_vec(int N_nu_mass, double T_CMB, double T_ncdm, double * a, double * mnu, int nout, int * status)"""
    ...
    return _ccllib.Omeganuh2_vec(N_nu_mass, T_CMB, T_ncdm, a, mnu, nout, status)

def rescale_musigma_s8(cosmo, psp, mg_rescale, s8_rescale, status):
    r"""rescale_musigma_s8(cosmology cosmo, f2d_t psp, int mg_rescale, int s8_rescale, int * status)"""


    return _ccllib.rescale_musigma_s8(cosmo, psp, mg_rescale, s8_rescale, status)
...
def fftlog_ComputeXi_general(mu, q, npk, N, k, pk, spherical_bessel, bessel_deriv, plaw, r, xi, status):
    r"""fftlog_ComputeXi_general(double mu, double q, int npk, int N, double * k, double ** pk, int spherical_bessel, double bessel_deriv, double plaw, double * r, double ** xi, int * status)"""


    return _ccllib.fftlog_ComputeXi_general(mu, q, npk, N, k, pk, spherical_bessel, bessel_deriv, plaw, r, xi, status)
...
def fftlog_transform_general(npk, k_in, fk_in, mu, q, spherical_bessel, bessel_deriv, plaw, nout, status):
    r"""fftlog_transform_general(int npk, double * k_in, double * fk_in, double mu, double q, int spherical_bessel, double bessel_deriv, double plaw, int nout, int * status)"""
    ...
    return _ccllib.fftlog_transform_general(npk, k_in, fk_in, mu, q, spherical_bessel, bessel_deriv, plaw, nout, status)
...
emulator_linpk = _ccllib.emulator_linpk
...
emulator_nlpk = _ccllib.emulator_nlpk
